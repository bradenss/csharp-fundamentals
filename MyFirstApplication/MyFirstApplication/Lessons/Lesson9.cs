...
internal class Lesson9
{
    ...
    /*
     Private access modifier can only be seen within the class, 
    struct or nested type.
     */
    ...
    /*
     Protect access modifier can only be seen within the 
    type or a child (derived) class.
     */
    ...
    /*
     Procted internal can be seen within the assembly or child(derived)
    ...
    /*
     Private Protected can be seen only within the class and child(derived)
    class from within the assembly.
     */
