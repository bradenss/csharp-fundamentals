...
/*
 Enums van be created either within a class or struct
or in the namespace
 */
public enum Day { Sat, Sun, Mon, Tue, Wed, Thu, Fri};
public enum IceCreamFlavors {  Vanilla, Choclate, Strawberry, RockyRoad}
...
internal class Lesson15
{
    ...
    public string FavoriteIceCream(IceCreamFlavors flavors)
    {
        string message = flavors switch
        {
            ...
            IceCreamFlavors.Choclate => $"My favorite is {IceCreamFlavors.Choclate}",
    ...
    /*
     Tuples are a group of types using paratesis and separating with a comma.
     */
    ...
    /*
     Using a tuple a return multiple results in a method
     */
