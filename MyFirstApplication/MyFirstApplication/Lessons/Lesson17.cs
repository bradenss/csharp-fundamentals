...
internal class Lesson17
{
    ...
    public void MyExceptionExample(House house)
    {
        ...
        {
            Console.WriteLine($"Null Referencces was thrown: {ex.Message}");
        }
    }

    // Try/Catch/Finally blocs used to evaluate an array and parsing
    public void MyArrayException()
    {
        ...
        {
            Console.WriteLine($"PLease provide atleast 1 argument: {ex.Message}");
        }
