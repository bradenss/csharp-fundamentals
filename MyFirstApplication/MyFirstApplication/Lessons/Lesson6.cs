...
internal class Lesson6
{
    ...
    /*
     The in parameter modifier is passed by reference.
    The argument can not be modified as it is read only.
     */
    ...
    /*
     The ref parameter modifier is passed by refeerence. The value changed
    in the method affects the called variable.
     */
    public void RedExample(ref int value)
    {
        value += 5;
    ...
    in does not have to be intitalized.
     */
